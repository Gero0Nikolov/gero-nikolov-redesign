...
if ( ! function_exists( 'geronikolov_setup' ) ) :
/**
 ...
 */
function geronikolov_setup() {
	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on Gero\'s, use a find and replace
	 * to change 'geronikolov' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'geronikolov', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'menu-1' => esc_html__( 'Primary', 'geronikolov' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'geronikolov_custom_background_args', array(
...
add_action( 'after_setup_theme', 'geronikolov_setup' );
 ...
 */
function geronikolov_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'geronikolov_content_width', 640 );
}
add_action( 'after_setup_theme', 'geronikolov_content_width', 0 );
 ...
 */
function geronikolov_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'geronikolov' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'geronikolov' ),
...
add_action( 'widgets_init', 'geronikolov_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function geronikolov_scripts() {
...
add_action( 'wp_enqueue_scripts', 'geronikolov_scripts' );
